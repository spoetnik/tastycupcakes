---
title: You Are Not in ControlVocê não está no controleNo está todo bajo tu controlВы этим не управляете
titleNeedsReview: true
slug: you-are-not-in-control
permalink: /ru/2009/06/you-are-not-in-control/
lang: ru
translationOf: /2009/06/you-are-not-in-control/
...
wordpress:
  id: 60
  sourceFile: output/ru/2009/06/you-are-not-in-control/index.html
  capture: modern
---
...
Em times de 4 ou mais pessoas, diga aos participantes para criarem tantos aviões de papel quanto possível. Quando lançados de trás de uma mesa em uma extremidade da sala, os aviões devem cruzar a sala e atingir a parede oposta.

O facilitador, fazendo o papel do cliente, pode rejeitar quaisquer aviões que não atendam ao seu padrão de qualidade.

Registre a quantidade de aviões criados/rejeitados, o tempo para ter o primeiro avião aprovado, o tempo para absorver um novo membro no time e o tempo para incorporar um novo requisito (primeiro avião amarelo).
...
_Primeira passagem: auto-organização e times interdisciplinares._
...
_Segunda passagem: comando-e-controle com especialistas.°_
...
Formando equipos de 4 o más miembros los participantes tienen que construir el número máximo de aviones de papel. Cuando lancen los aviones desde detrás de una mesa de la habitación, éstos tienen que atravesar la habitación y tocar la pared opuesta más lejana.

El facilitador, actuando como cliente, puede rechazar los aviones que no cumplan los requisitos de calidad estándar.

Hay que contar el número de aviones realizados y aprobados. También hay que contabilizar el tiempo empleado en aprobar el primer avión, el tiempo en adquirir un nuevo miembro en el equipo y el tiempo en implementar un nuevo requisito (primer avión amarillo).
...
_Первая итерация: самоорганизующиеся и кросс-функциональные команды._
...
_Вторая итерация: роли узко специализированы и осуществляется жесткий контроль._
...
-   Дизайнер (Изгибатель): Может изгибать бумагу под новым углом до тех пор, пока ее поверхности не касаются
    друг друга (дальше это уже будет работа Конструктора).
-   Летчик-испытатель: Может осуществлять окончательную подгонку самолетика в целом.
...
-   Самоорганизующиеся и кросс-функциональные команды способны лучше адаптироваться к изменениям, чем те
    команды, в которых роли узко специализированы и осуществляется жесткий контроль.
-   К тому же, они быстрее выводят продукцию на рынок и являются более продуктивными.
